 ...
 */
package edu.royhanreza.latihanmvcjdbc.controller;

import edu.royhanreza.latihanmvcjdbc.model.PelangganModel;
import edu.royhanreza.latihanmvcjdbc.view.PelangganView;
...
public class PelangganController {
    ...
    public void insertPelanggan(PelangganView view) {
        ...
        if (nama.trim().equals("")) {
            ...
            JOptionPane.showMessageDialog(view, "karakter > 255 karakter");
        } else if (telepon.length() > 255) {
            JOptionPane.showMessageDialog(view, "karakter > 255 karakter");
            ...
            try {
                ...
                JOptionPane.showMessageDialog(view, new Object[]{"Terjadi error di database", throwable.getMessage()});
            }
